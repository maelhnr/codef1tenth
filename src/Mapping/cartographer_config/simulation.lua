...
options = {
  ...
  published_frame = "map",  -- published frame name 
  -- laser_frame = "laser",
...
MAP_BUILDER.use_trajectory_builder_3d = false  -- whether use 3D SLAM
MAP_BUILDER.num_background_threads  = 5.0  
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 100  -- Number of range data for submaps in the 2D track builder  
...
TRAJECTORY_BUILDER_2D.max_range = 29.0  -- the maximum scanning range of the lidar
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 5.  -- Restricted to maximum LiDAR scanning range  
TRAJECTORY_BUILDER_2D.use_imu_data = false -- true  -- whether use IMU data
